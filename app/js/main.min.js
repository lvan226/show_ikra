$(function () {
  ...
  let modalMenu = document.getElementById('modal');
  ...
  // Works
  let worksClose = document.getElementById('works-close');
  let worksOpen = document.getElementById('works-open');
  let works = document.getElementById('works');

  worksOpen.addEventListener('click', (e) => {
    e.preventDefault();
